...
//include "insert_update_delete_bukutamu/insertbukutamu.php"; 
include "insert_update_delete_bukutamu/koneksi.php"; 
include "insert_update_delete_bukutamu/updatebukutamu.php";  
?>
<!DOCTYPE <html></html>
...
?> 
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                            <a class="yeskandas" href="karyawan.php"c>
                                <div>
...
?> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Buku Tamu</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                 ...
                 <div class="form-group">
                  <label for="nama_bukutamu">Nama</label>
                  <input type="text" class="form-control" id="nama" name="nama" required="required" value ="<?php echo $row['nama'];?>">
                </div>
                     <div class="form-group">
                ...
                <div class="form-group">
                  <label for="lembaga_bukutamu">Lembaga / Instansi</label>
                  <input type="text" class="form-control" id="lembaga" name="lembaga" required="required" value="<?php echo $row['detail_jenis_donatur'];?>">
                </div>
                <div class="form-group">
                  <label for="nomor_bukutamu">Nomor Telepon</label>
                  <input type="text" class="form-control" id="tlp" name="tlp" required="required" value="<?php echo $row['nomor_telepon'];?>">
                </div>
                <div class="form-group">
                  <label for="alamat_bukutamu">Alamat Lengkap</label>
                  <input type="text" class="form-control" id="alamat" name="alamat" required="required" value="<?php echo $row['alamat'];?>">
                </div>
                <div class="form-group">
                  <label for="keperluan_bukutamu">Keperluan</label>
                  <textarea type="text" class="form-control" id="keperluan" name="keperluan" required="required" value="<?php echo $row['keperluan'];?>"></textarea>
                </div>
