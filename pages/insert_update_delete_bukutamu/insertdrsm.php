<?php
  ...
  $Sql = "SELECT * FROM tb_mst_layanan where jenis_keluhan=1 ORDER BY jam_catat DESC ";
  ...
  $sampai="";
...

      {
...

          {
							...
							$Sql = "SELECT * FROM tb_mst_layanan where jenis_keluhan=1 and tanggal_catat BETWEEN '$dari' and '$sampai' ORDER BY jam_catat DESC";
