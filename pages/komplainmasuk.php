            ...
            <form method="post" action="" class="form" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="nama" class="form-control" id="nama_komplain" required placeholder="*isikan nama lengkap">
                </div>
                <div class="form-group">
                  <label for="sumber_informasi _komplain">Sumber Informasi</label>
                  <input type="text" name="sumber" class="form-control" id="sumber_informasi" required placeholder="*isikan sumber informasi lengkap">
                </div>
                <div class="form-group">
                  <label for="keluhan_komplain">Keluhan</label>
                  <textarea type="text" name="keluhan" class="form-control" id="keluhan_komplain" required placeholder="*Isikan perihal keluhan"></textarea>
                </div>
                <div class="form-group">
                  <label for="keterangan_komplain">Keterangan</label>
                  <textarea type="text" name="ket" class="form-control" id="keluhan_komplain" name="keterangan" required placeholder="*Isikan keterangan"></textarea>
                </div>
