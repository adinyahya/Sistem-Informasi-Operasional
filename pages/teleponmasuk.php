...
include "insert_update_delete_teleponmasuk/insertteleponmasuk.php"; 
...
?> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Telepon Tamu</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_telp" required name="namat" placeholder="*isikan nama lengkap">
                </div>
 <style>
        ...
        for(var i=0;i != hideninp.length;i++)
            {
                ...
                <div class="form-group">
                  <label for="detail_asal" class="form-controlxyz">Detail Asal</label>
                  <input type="text" class="form-controlxyz" name="detailt" id="detail_telp" placeholder="*isikan detail informasi">
                </div>
                <div class="form-group">
                  <label for="telpx">Nomor Telepon</label>
                  <input type="text" class="form-control" required  id="nomor_telp" name="tlpt" placeholder="*isikan nomor telepon">
                </div>
                <div class="form-group">
                  <label for="keperluan">Keperluan</label>
                  <textarea type="text" class="form-control" required  id="keperluan_telp" name="keperluant" placeholder="*isikan keperluan"></textarea>
                </div>
               </div>
<style>
#tmpd
