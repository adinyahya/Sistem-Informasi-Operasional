...
include "insert_update_delete_inventaris/insertinventaris.php";
...
?> 
            ...
            <form method="post" action="" class="form" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="nama" class="form-control" id="nama_item_barang" required placeholder="*isikan nama">
                </div>
                                 <div class="form-group">
                  <label for="satuan">Satuan</label>
                  <input type="text" name="satwan" class="form-control" id="satuan" required placeholder="*isikan satukan">
                </div>
                 <div class="form-group">
                  <label for="stok">Stok</label>
                  <input type="text" name="setok" class="form-control" id="stok" required placeholder="*isikan stok">
                </div>
                 <div class="form-group">
   ...
   include "insert_update_delete_inventaris/koneksi.php";
    ...
    $sql = "SELECT * FROM tb_mst_golongan ORDER BY nama_golongan ASC";
$result = mysqli_query($conn,$sql); 
    ...
    ?>
                  ...
                  <textarea type="text" name="desk" class="form-control" id="deskripsi_inventaris" required  placeholder="*Isikan Deskripsi Item / Barang"></textarea>
                </div>
                 <div class="form-group">
                  <label for="tempat">Tempat</label>
                  <input type="text" name="tempat" class="form-control" required  placeholder="*Isikan Deskripsi Tempat"></textarea>
                </div>
        <div class="form-group">
<label >Gambar </label>
