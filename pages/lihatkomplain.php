...
include "insert_update_delete_komplainmasuk/deletekomplainmasuk.php";
?>
<!DOCTYPE <html>
<html lang="en">
...
?> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Laporan Komplain Masuk</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <div align="right">
                            <a href="insert_update_delete_komplainmasuk/printkomplain.php" class="btn btn-info">
                              <i class="fa fa-print">
                                <t></t>Cetak
                              </i>
                            </a>
               ...
               .form-controlx:-ms-input-placeholder{
				...
				<div class="table-responsive dataTable_wrapper">
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
							<?php
                              include "insert_update_delete_komplainmasuk/insertdrsm.php";
							?>
						</tbody>
					</table>
				</div>
