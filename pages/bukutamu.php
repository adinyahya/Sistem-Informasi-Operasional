            ...
            <div class="row">
                <div class="col-lg-12">
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" name="nama" required placeholder="*Isikan nama lengkap">
                </div>
                     <div class="form-group">
                ...
                <div class="form-group">
                  <label for="lembaga_bukutamu">Lembaga / Instansi / Perorangan</label>
                  <input type="text" class="form-control" id="lembaga" name="lembaga"required  placeholder="*Isikan lembaga / instansi / perorangan">
                </div>
                <div class="form-group">
                  <label for="nomor_bukutamu">Nomor Telepon</label>
                  <input type="text" class="form-control" id="tlp" name="tlp" required placeholder="*Isikan nomor telepon">
                </div>
                <div class="form-group">
                  <label for="alamat_bukutamu">Alamat Lengkap</label>
                  <input type="text" class="form-control" id="alamat" name="alamat" required placeholder="*Isikan alamat lengkap">
                </div>
                <div class="form-group">
                  <label for="keperluan_bukutamu">Keperluan</label>
                  <textarea type="text" class="form-control" id="keperluan" name="keperluan"required  placeholder="*Isikan keperluan"></textarea>
                </div>
