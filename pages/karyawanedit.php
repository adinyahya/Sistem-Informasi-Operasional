...
include "registrasiuserkaryawan/editmd5.php";
...
$("#idkota").html(msg);
  ...
  <?php
    ...
    <input name='idpeg' class="form-control" type='text' required="required" value ="<?php echo $row['id_peg'];?>">
  </div>
     <div class="form-group">
                  <label for="id_user">Id User</label>
    <input name='id_user' class="form-control" type='text' required="required" value ="<?php echo $row['id_user'];?>">
  </div>
     <div class="form-group">
                  <label for="nmuser">Nama User</label>
    <input name='nmuser' class="form-control" type='text' required="required" value ="<?php echo $row['nama_user'];?>">
  </div>
     <div class="form-group">
                  <label for="passmd5">Password</label>
    <input name='passmd5' class="form-control" type='text' required="required" value ="<?php echo $row['password'];?>">
  </div>
    <div class="form-group">
    ...
    <input name='vermd5' class="form-control" type='text' value ="<?php echo $row['password'];?>">
  </div>
   <div class="form-group">
...
<label>Layanan</label>
  <select class="form-control" name="layanan" >
   ...
   include "registrasiuserkaryawan/koneksi.php";
    ...
    $sql1 = "SELECT * FROM tb_mst_regencies ORDER BY name ASC";
