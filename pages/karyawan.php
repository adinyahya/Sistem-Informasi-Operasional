                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <a href="registrasikaryawan.php"><i class="fa fa-plus"> Tambahkan Karyawan </i></a>
                        </div>
			...
			<div class="panel-body">
				<div class="table-responsive dataTable_wrapper">
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
							<?php
								$Sql ="SELECT id_peg, id_user, nama_user, password, hak_akses, layanan, active FROM tb_user";
							...
							$nomor = 0;
                             ...
                             while($tampil = mysqli_fetch_array($say)) { 
								...
								echo '<tr>';
									echo '<td>'.$nomor.'</td>';	
									echo '<td>'.$tampil['id_peg'].'</td>';	
									echo '<td>'.$tampil['id_user'].'</td>';	
									echo '<td>'.$tampil['nama_user'].'</td>';	
									echo '<td>'.$tampil['password'].'</td>';
                                    	
									echo '<td>'.$tampil['hak_akses'].'</td>';

									echo '<td>'.$tampil['layanan'].'</td>';

									echo '<td>'.$tampil['active'].'</td>';
                                    
									echo '<td><a href="karyawanedit.php?id='.$tampil['id_peg'].'" class="btn btn-success"><i class="fa fa-gear"></i></a>
													<a href="registrasiuserkaryawan/deletekaryawan.php?id='.$tampil['id_peg'].'" class="btn btn-warning"><i class="fa fa-trash"></i></a>
									</td>';
