...
include "insert_update_delete_suratmasuk/insertsuratmasuk.php"; 
             ...
             <form method="post" action="" class="form" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_suratmasuk" name="namap" required placeholder="*Isikan nama lengkap">
                </div>
                   
                <div class="form-group">
                  <label for="nomor_suratmasuk">Nomor Surat</label>
                  <input type="text" class="form-control" id="nomor_suratmasuk" name="nomorp" required placeholder="*isikan nomor surat lengkap">
                </div>
                 <div class="form-group">
                  <label for="tanggal_suratmasuk">Tanggal Surat</label>
				 
                  <input type="date" class="tanggal" name="tanggalp" required id="tanggalp" data-date-format="yyyy-mm-dd">
                
				</div>
                <!-- <div class="form-group">
                  <label for="tanggal_suratmasuk">Tanggal Surat</label>
                  <input type="text" class="form-control" id="tanggal_suratmasuk" name="tanggalp" placeholder="*isikan nomor telepon">
                </div> -->
                <div class="form-group">
                  <label for="isi_suratmasuk">Isi Surat</label>
                  <textarea type="text" class="form-control" id="isi_suratmasuk" required name="isip" placeholder="*Isikan Perihal Surat"></textarea>
                </div>
