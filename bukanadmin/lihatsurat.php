...
include "insert_update_delete_suratmasuk/deletesuratmasuk.php";
?>
<!DOCTYPE <html>
<html lang="en">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          ...
                          <div align="right">
                            <a href="insert_update_delete_suratmasuk/printsuratmasuk.php" class="btn btn-info">
                              <i class="fa fa-print">
                                <t></t>Cetak
                              </i>
                            </a>
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
							<?php
                              ...
                              include "insert_update_delete_suratmasuk/insertdrsm.php";
							?>
						</tbody>
					</table>
				</div>
