...
include "insert_update_delete_komplainmasuk/updatekomplainmasuk.php";
...
?> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Komplain</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <form method="post" action="" class="form" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="nama" class="form-control" id="nama_komplain" required="required" value ="<?php echo $row['nama'];?>" >
                </div>
                <div class="form-group">
                  <label for="sumber_informasi _komplain">Sumber Informasi</label>
                  <input type="text" name="sumber" class="form-control" id="sumber_informasi" required="required" value ="<?php echo $row['sumber_informasi'];?>">
                </div>
                <div class="form-group">
                  <label for="keluhan_komplain">Keluhan</label>
                  <textarea type="text" name="keluhan" class="form-control" id="keluhan_komplain" required="required" value ="<?php echo $row['isi_informasi'];?>"></textarea>
                </div>
                <div class="form-group">
                  <label for="keterangan_komplain">Keterangan</label>
                  <textarea type="text" name="ket" class="form-control" id="keluhan_komplain" name="keterangan" required="required" value ="<?php echo $row['tindakan'];?>"></textarea>
                </div>
