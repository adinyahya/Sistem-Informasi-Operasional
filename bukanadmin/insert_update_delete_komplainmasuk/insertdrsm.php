<?php
  ...
  if(empty($_POST["dr"])){
							...
							$Sql = "SELECT * FROM tb_mst_layanan where jenis_keluhan=5 and layanan='$lokasilay' ORDER BY jam_catat DESC";
  ...
  $sampai="";
...

      {
...

          {
			...
			$Sql = "SELECT * FROM tb_mst_layanan where jenis_keluhan=5 and layanan='$lokasilay' and tanggal_catat BETWEEN '$dari' and '$sampai' ORDER BY jam_catat DESC";
