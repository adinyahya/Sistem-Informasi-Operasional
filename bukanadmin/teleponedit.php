...
include "insert_update_delete_teleponmasuk/updateteleponmasuk.php"; 
include "insert_update_delete_teleponmasuk/koneksi.php"; 
...
?> 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Telepon Tamu</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="namax">Nama Penelepon</label>
                  <input type="text" class="form-control" id="nama_telp" name="namat" required="required" value ="<?php echo $row['nama'];?>">
                </div>
 <style>
        ...
        for(var i=0;i != hideninp.length;i++)
            {
                if(select.value =="Non Donatur"){
                ...
                }else
                    {
                     ...
                     <div class="form-group">
                  <label>Asal</label>
                  <select class="form-control" name="asalt" id="sal" onclick="showHide()" >
                ...
                <div class="form-group">
                  <label for="detail_asal" class="form-controlx">Detail Asal</label>
                  <input type="text" class="form-controlx" name="detailt" id="detail_telp" value ="<?php echo $row['detail_jenis_donatur'];?>">
                </div>
                <div class="form-group">
                  <label for="telpx">Nomor Telepon</label>
                  <input type="text" class="form-control" id="nomor_telp" name="tlpt" required="required" value ="<?php echo $row['nomor_telepon'];?>">
                </div>
                <div class="form-group">
                  <label for="keperluan">Keperluan</label>
                  <textarea type="text" class="form-control" id="keperluan_telp" name="keperluant" required="required" value ="<?php echo $row['keperluan'];?>" ></textarea>
                </div>
