             ...
             <form method="post" action="" class="form" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_suratmasuk" name="namap" placeholder="*Isikan nama lengkap">
                </div>
                   
                <div class="form-group">
                  <label for="nomor_suratmasuk">Nomor Surat</label>
                  <input type="text" class="form-control" id="nomor_suratmasuk" name="nomorp" placeholder="*isikan nomor surat lengkap">
                </div>
                 <div class="form-group">
                  <label for="tanggal_suratmasuk">Tanggal Surat</label>
				 
                  <input type="date" class="tanggal" name="tanggalp" id="tanggalp" data-date-format="yyyy-mm-dd">
                ...
                <div class="form-group">
                  ...
                  <textarea type="text" class="form-control" id="isi_suratmasuk" name="isip" placeholder="*Isikan Perihal Surat"></textarea>
                </div>
