...
include "koneksi.php";
     ...
     $lokasilayanan="";
      ...
      if($_SERVER["REQUEST_METHOD"]=="POST")
      {
          ...
          {
              $sql = "INSERT INTO tb_mst_layanan SET nama='$namap',  nomor_surat='$nomorp' ,tanggal_surat='$tanggalp', isi_surat='$isip', tanggal_catat='$tgl',jam_catat='$jamX', penerima='$penerima', jenis_keluhan='4', nama_keluhan='SURAT MASUK', id_kota='$kotaid', layanan='$lokasilayanan'";
