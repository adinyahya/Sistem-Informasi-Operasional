...
header("content-disposition: attachment;filename=laporan_buku_tamu".date('dmY').".xls");
 
$Sql = "SELECT * FROM tb_mst_layanan where jenis_keluhan='1'";                         
	...
	$nomor = 0;
{
 echo "<table border='1px' align='center'>";    
          ...
          echo "<th bgcolor='#FFFFFF' align='center' width='200'>ALAMAT</th>"; 
 ...
 while($row = mysqli_fetch_array($result)) {
  ...
  echo "<tr>";    
		     ...
		     echo "<td align='center' bgcolor='#FFFFFF'>".$row["alamat"]."</td>";
